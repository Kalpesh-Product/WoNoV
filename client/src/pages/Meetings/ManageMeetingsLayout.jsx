...
const ManageMeetingsLayout = () => {
  ...
  // Map routes to tabs
  const tabs = [
    { label: "Internal Meetings", path: "internal-meetings" },
    { label: "External Clients", path: "external-clients" },
  ];

  useEffect(() => {
    if (location.pathname === "/app/meetings/manage-meetings") {
      navigate("/app/meetings/manage-meetings/internal-meetings", {
        replace: true,
      });
    }
  }, [location, navigate]);
