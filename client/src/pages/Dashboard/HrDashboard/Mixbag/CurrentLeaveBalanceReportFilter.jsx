...
const CurrentLeaveBalanceReportFilter = ({
  open,
  onClose,
  value,
  onApply,
  ...
  const reset = () => {
    const defaults = { leaveType: "All", employee: "" };
    setFilters(defaults);
    onApply(defaults);
  };
      ...
      <div className="flex flex-col gap-5 p-3">
        <div className="grid grid-cols-[170px_1fr] items-center gap-4">
          ...
          <TextField
            ...
            onChange={(event) =>
              setFilters((current) => ({ ...current, leaveType: event.target.value }))
            }
          >
        ...
        <div className="grid grid-cols-[170px_1fr] items-center gap-4">
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField {...params} placeholder="Select Employee Name" />
            )}
          />
        </div>
...
export default CurrentLeaveBalanceReportFilter;
