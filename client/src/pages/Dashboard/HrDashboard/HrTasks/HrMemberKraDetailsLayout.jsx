...
const HrMemberKraDetailsLayout = () => {
  ...
  const basePath = pathname.includes("/mix-bag/department-kpa-kra/")
    ? `/app/dashboard/HR-dashboard/mix-bag/department-kpa-kra/department-KRA/${encodeURIComponent(department)}/member-wise`
    : `/app/dashboard/HR-dashboard/overall-KPA/department-KRA/${encodeURIComponent(department)}/member-wise`;
