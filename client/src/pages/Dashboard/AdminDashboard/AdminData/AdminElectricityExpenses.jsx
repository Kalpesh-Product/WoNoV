  ...
  return (
    <div className="p-4 flex flex-col gap-8">
      ...
      >
        ...
        {transformedElectricityData.length > 0 &&
          transformedElectricityData.map((electricity, index) => (
            ...
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <DetalisFormatted
                  ...
                  detail={selectedAsset.consumptionKWh.toLocaleString()}
                />
                <DetalisFormatted
                  title="Paid Date"
                  detail={
                    selectedAsset.paidDate
                      ? dayjs(selectedAsset.paidDate, "DD-MM-YYYY").format(
                          "DD-MM-YYYY"
                        )
                      : "Not Paid"
                  }
                ...
                <DetalisFormatted
                  title="Billing Date"
                  detail={dayjs(selectedAsset.billingDate, "DD-MM-YYYY").format(
                    "DD-MM-YYYY"
                  )}
                />
                ...
                <DetalisFormatted
                  title="Paid Status"
                  detail={selectedAsset.paid ? "Paid" : "Unpaid"}
                />
              </div>
            </div>
          )}
