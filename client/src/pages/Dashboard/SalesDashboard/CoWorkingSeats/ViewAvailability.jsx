...
const mockSalesData = [
...

  {
    client: "Axis Bank",
    memberDetails: [
      { member: "Amit Sharma", date: "2024-02-25" },
      { member: "Priya Verma", date: "2024-02-26" },
      { member: "Rahul Patel", date: "2024-02-26" },
      { member: "Anjali Gupta", date: "2024-02-26" },
      { member: "Vikram Singh", date: "2024-02-26" },
    ],
  },
  {
    client: "SquadStack",
    memberDetails: [
      { member: "Arjun Mehra", date: "2024-03-01" },
      { member: "Sneha Kapoor", date: "2024-03-01" },
      { member: "Rohan Malhotra", date: "2024-03-02" },
      { member: "Kavita Joshi", date: "2024-03-02" },
      { member: "Nikhil Rana", date: "2024-03-02" },
      { member: "Divya Nair", date: "2024-03-03" },
      { member: "Siddharth Iyer", date: "2024-03-03" },
      { member: "Pooja Desai", date: "2024-03-03" },
      { member: "Aditya Kulkarni", date: "2024-03-04" },
      { member: "Meera Saxena", date: "2024-03-04" },
      { member: "Karan Thakur", date: "2024-03-04" },
      { member: "Shruti Bhatt", date: "2024-03-05" },
      { member: "Vivek Chawla", date: "2024-03-05" },
      { member: "Neha Aggarwal", date: "2024-03-05" },
      { member: "Pranav Dubey", date: "2024-03-06" },
      { member: "Aarti Saini", date: "2024-03-06" },
      { member: "Manish Vyas", date: "2024-03-06" },
      { member: "Riya Sengupta", date: "2024-03-07" },
      { member: "Saurabh Mishra", date: "2024-03-07" },
      { member: "Tanya Grover", date: "2024-03-07" },
    ],
  },
  {
    client: "BDO",
    memberDetails: [
      { member: "Suresh Yadav", date: "2024-02-25" },
      { member: "Lakshmi Menon", date: "2024-02-26" },
      { member: "Deepak Rawat", date: "2024-02-26" },
      { member: "Sunita Pillai", date: "2024-02-26" },
      { member: "Rakesh Jha", date: "2024-02-26" },
    ],
  },
];
