...
const FinanceSettings = () => {
  ...
  // Redirect to "bulk-upload" if the current path is "/finance-dashboard/settings"
  useEffect(() => {
    if (location.pathname === "/app/dashboard/finance-dashboard/settings") {
      navigate("/app/dashboard/finance-dashboard/settings/bulk-upload", {
        replace: true,
      });
    }
  }, [location, navigate]);
