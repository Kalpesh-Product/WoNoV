...
const Cashflow = () => {
  ...
  useEffect(() => {
    if (location.pathname === "/app/dashboard/finance-dashboard/cashflow") {
      navigate("/app/dashboard/finance-dashboard/cashflow/projections", {
        replace: true,
      });
    }
  }, [location, navigate]);
  ...
  const showTabs = !location.pathname.includes("projections/");
