...
const EarningsLayout = () => {
  ...
  // Map routes to tabs
  const tabs = [
    { label: "Actual", path: "actual-business" },
    { label: "Projected", path: "revenue-target" },
  ];

  // Redirect to "view-employees" if the current path is "/hr-dashboard/compliances"
  useEffect(() => {
    if (location.pathname === "/app/dashboard/sales-dashboard/turnover") {
      navigate("/app/dashboard/sales-dashboard/turnover/actual-business", {
        replace: true,
      });
    }
  }, [location, navigate]);
